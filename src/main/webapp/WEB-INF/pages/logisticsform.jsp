	...
	<div id="main">
		...
		<div class="section pt-10 pb-10">
			<div class="container" align="center">
				<div class="row">
					<div class="col-sm-12">
						<form:form action="saveLogistics" method="post" modelAttribute="order">
						<table id="tbl">
							<form:hidden path="id"/>
							...
							<tr>
								<td colspan="2" style="text-align:center; font-size:26px; font-family:Arial, Helvetica, sans-serif">Update Location</td>
							</tr>
		
							<tr align="center">
								<td><img id="smallimg" alt="" src="images/city.png"></td>
								<td><form:input type="text" path="city" readonly="true"/></td>
							</tr>
							<tr>
								<td><img id="smallimg" alt="" src="images/address.png"></td>
								<td><form:input type="text" path="addres" readonly="true" /></td>
							</tr>
							<tr>
								<td><img id="smallimg" alt="" src="images/pcode.png"></td>
								<td><form:textarea path="location" placeholder="Location Now" /></td>
							</tr>
							<tr align="center">
