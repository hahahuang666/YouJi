...
<head>
<style>
	#payimg{height:200px;width:200px;float:left;}
</style>
	...
	<div id="main">
		<div class="section section-bg-10 pt-11 pb-17">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="page-title text-center">Pay</h2>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="section pt-7 pb-7">
			<div class="container">
				<div class="row">
					<div class="col-md-8" style="margin-left: 80px;font-size: 20px;">
					<%int id=(int)session.getAttribute("id");%>
					 <c:form action="paid?id=${id}" method="post">
						<table>
							<%String totalprice=(String)session.getAttribute("total");%>
							<tr><td>Need pay:</td><td>$<%=totalprice %></td></tr>
							<tr><td>You can choose:<br><br></td></tr>
							
							<tr>
								<td><img id="payimg" src="images/alipay.jpg" ></td>
								<td></td>
								<td><img id="payimg" src="images/wechatpay.jpg"></td>
							</tr>
							
							<tr><td><br><input type="submit" name="submit" value="Payment Completion"/></td></tr>
						</table>
						</c:form>
					</div>
				</div>
