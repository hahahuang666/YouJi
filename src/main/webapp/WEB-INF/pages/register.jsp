			...
			<div class="container" align="center">
				<div class="row">
					<div class="col-sm-12">
						...
						<table id="tbl">
							<tr>
								<td colspan="2" style="text-align:center; font-size:26px; font-family:Arial, Helvetica, sans-serif">Registration</td>
							</tr>
							<form:hidden path="id"/>
							<tr align="center">
								<td><img id="smallimg" alt="" src="images/user.png"></td>
								<td><form:input type="text" path="name" placeholder="username" /></td>
							</tr>
							<tr>
							...
							<tr align="center">
								<td colspan="2"><input style="border:0; border-radius:6px; background-color:rgba(155,155,155,0.7);" type="submit" name="submit" value="Register" /></td>
							</tr>
						</table>
						</form:form>
					</div>
