	...
	<div id="main">
		...
		<div class="section pt-10 pb-10">
			<div class="container" align="center">
				<div class="row">
					<div class="col-sm-12">
						<form:form action="saveCustomer1" method="post" modelAttribute="customer">
						<table id="tbl">
							<tr>
								<td colspan="2" style="text-align:center; font-size:26px; font-family:Arial, Helvetica, sans-serif">New/Edit Customer</td>
							</tr>
							<form:hidden path="id"/>
							<tr align="center">
