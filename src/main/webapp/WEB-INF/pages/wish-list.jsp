	...
	<div id="main">
		<div class="section section-bg-10 pt-11 pb-17">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="page-title text-center">Wish List</h2>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-md-8" style="margin-left: 140px;">
						<table class="table shop-cart">
							<tbody>
								<c:forEach var="wishlist" items="${datawish.listWish}">
								<tr class="cart_item">
									...
									<td>
										<a style="font-size: 18px;">${wishlist.pname}</a>
									</td>
									<td>
										<a style="font-size: 18px;">${wishlist.category}</a>
									</td>
									<td>
										<a style="font-size: 18px;">$${wishlist.price}</a>
									</td>
									<td>
										<a href="addtocart?pid=${wishlist.pid}" style="color: Green;font-size: 20px;">Add To Cart</a>
									</td>
									<td class="product-remove">
										<a href="removewish?wid=${wishlist.wid}" class="remove">×</a>
									</td>
								</tr>
								</c:forEach>
								<tr>
									<td colspan="6" class="actions">
										...
										<a class="update-cart" href="wish-list"> Update Wishlist</a>
									</td>
								</tr>
							</tbody>
						</table>
